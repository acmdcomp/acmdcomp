    ...
    if ch==1:
        ...
        while ct<5:
            ...
            if loginchoice==1:
                ...
                newuser=[nm, password, 'driver', inbox]
                login[username]=newuser
                ...
                nm=input('Enter your name ')
                newuser=[nm, password, 'client', inbox]
                login[username]=newuser 
                ag=int(input('Enter your age '))
                g=input('Enter your gender(Enter M for male and F for female) ')
                if g=='m':
...
if flag ==1:
    ...
    samplelist=[['Raju', 'Indiranagar'],['Vishal','CV Raman nagar'],['Atul','Koramangala'],['Shourya','Whitefield'],['Kiran','Old Airport Road']]
